...
class AppTheme {
  ...
  static final Color _lightOnPrimaryColor = Colors.blueGrey.shade500;
  ...
  static const TextStyle _ligthBodyText = TextStyle(
      color: _lightTextColorPrimary,
      fontFamily: "Rubik",
  ...
  static final TextStyle _darkThemeBodyTextStyle = _ligthBodyText.copyWith(
      color: _darkTextColorPrimary); //_darkOnPrimaryColor);
